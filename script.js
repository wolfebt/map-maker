                            ...
                            layers.forEach(layer => {
                                if (layer.data[key]) {
                                    ...
                                    if(layer.data[key].objectKey) {
                                        ...
                                        content += `&nbsp;&nbsp;Object: ${objectCategories[mainCat][subCat][objKey].name}<br>`;
                                    }
        ...
        canvas.addEventListener('mouseup', e => {
            if (e.button === 0) { // Left-click release
                ...
                if (isDrawingShape && isShapeMode) {
                    const endPoint = pixelToHex(e.clientX - canvas.getBoundingClientRect().left, e.clientY - canvas.getBoundingClientRect().top, currentTool === 'pencil');
                    if (currentTool === 'terrain') {
